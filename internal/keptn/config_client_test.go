...
func (rc *mockResourceClient) GetResource(_ context.Context, _ string, _ string, _ string, _ string) (string, error) {
	rc.t.Fatalf("GetResource() should not be needed in this mock!")
	return "", nil
}

func (rc *mockResourceClient) GetProjectResource(_ context.Context, project string, resourceURI string) (string, error) {
...
func (rc *mockResourceClient) GetStageResource(_ context.Context, project string, stage string, resourceURI string) (string, error) {
	assert.EqualValues(rc.t, testProject, project)
...
func (rc *mockResourceClient) GetServiceResource(_ context.Context, project string, stage string, service string, resourceURI string) (string, error) {
	assert.EqualValues(rc.t, testProject, project)
	assert.EqualValues(rc.t, testStage, stage)
...
func (rc *mockResourceClient) UploadResource(_ context.Context, _ []byte, _ string, _ string, _ string, _ string) error {
