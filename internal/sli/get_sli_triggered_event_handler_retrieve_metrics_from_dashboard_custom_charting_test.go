...
func TestRetrieveMetricsFromDashboardCustomChartingTile_SplitByServiceKeyRequestFilterByAutoTag(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(SERVICE_METHOD),fromRelationships.isServiceMethodOfService(type(SERVICE),tag(\"keptnmanager\"))", "builtin:service.keyRequest.totalProcessingTime:splitBy(\"dt.entity.service_method\"):avg:names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_NoSplitByNoFilterBy(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(SERVICE)", "builtin:service.response.time:splitBy():avg:names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_SplitByServiceFilterByAutoTag(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(SERVICE),tag(\"keptn_managed\")", "builtin:service.response.time:splitBy(\"dt.entity.service\"):avg:names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_SplitByServiceFilterBySpecificEntity(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(SERVICE),entityId(\"SERVICE-C6876D601CA5DDFD\")", "builtin:service.response.time:splitBy(\"dt.entity.service\"):avg:names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_OldTest_WorkerProcessCount(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(PROCESS_GROUP_INSTANCE)", "builtin:tech.generic.processCount:splitBy():avg:names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_OldTest_ResponseTimeP90(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(SERVICE)", "builtin:service.response.time:splitBy():percentile(90.000000):names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_OldTest_ResponseTimeP50(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(SERVICE)", "builtin:service.response.time:splitBy():percentile(50.000000):names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_OldTest_ProcessMemoryAvg(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(PROCESS_GROUP_INSTANCE)", "builtin:tech.generic.mem.workingSetSize:splitBy():avg:names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_OldTest_ProcessCPUAvg(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(PROCESS_GROUP_INSTANCE)", "builtin:tech.generic.cpu.usage:splitBy():avg:names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_OldTest_Throughput(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(SERVICE)", "builtin:service.requestCount.total:splitBy():value:names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_OldTest_HostCPUUsageAvg(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(HOST)", "builtin:host.cpu.usage:splitBy():avg:names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_OldTest_HostMemoryUsageAvg(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(HOST)", "builtin:host.mem.usage:splitBy():avg:names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_OldTest_HostDiskQueueLengthMax(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(HOST)", "builtin:host.disk.queueLength:splitBy():max:names")
...
func TestRetrieveMetricsFromDashboardCustomChartingTile_OldTest_NonDbChildCallCount(t *testing.T) {
	...
	expectedMetricsRequest := buildMetricsV2QueryRequestStringWithEntitySelector("type(SERVICE)", "builtin:service.nonDbChildCallCount:splitBy():value:names")
