...
// List all possible combinations of three threshold colors, where each one may be one of three valid colors (for pass, warn or fail) or an invalid color.
...
var threeValueTestComponentVariants = []valueTestComponent{
	...
	// createInvalidValueTestComponent([]*float64{&thresholdValue100, nil, nil}, missingValueErrorSubstring3),  // combination 3: redundant due to combination 2
	// createInvalidValueTestComponent([]*float64{&thresholdValue200, nil, nil}, missingValueErrorSubstring3), // combination 4: redundant due to combination 2
	...
	// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue0, nil}, missingValueErrorSubstring3),  // combination 8: redundant due to combination 7

	// createInvalidValueTestComponent([]*float64{nil, &thresholdValue100, nil}, missingValueErrorSubstring1, missingValueErrorSubstring3),  // combination 9: redundant due to combination 5
	createInvalidValueTestComponent([]*float64{&thresholdValue0, &thresholdValue100, nil}, missingValueErrorSubstring3), // combination 10
	// createInvalidValueTestComponent([]*float64{&thresholdValue100, &thresholdValue100, nil}, missingValueErrorSubstring3, valueSequenceErrorSubstring), // combination 11: redundant due to combination 6
	// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue100, nil}, missingValueErrorSubstring3), //combination 12: redundant due to combination 7

	// createInvalidValueTestComponent([]*float64{nil, &thresholdValue200, nil}, missingValueErrorSubstring1, missingValueErrorSubstring3), // combination 13: redundant due to combination 5
	// createInvalidValueTestComponent([]*float64{&thresholdValue0, &thresholdValue200, nil}, missingValueErrorSubstring3), // combination 14: redundant due to combination 10
	// createInvalidValueTestComponent([]*float64{&thresholdValue100, &thresholdValue200, nil}, missingValueErrorSubstring3), // combination 15: redundant due to combination 10
	// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue200, nil}, missingValueErrorSubstring3, valueSequenceErrorSubstring), // combination 16: redundant due to combination 6
	...
	// createValidValueTestComponent([]*float64{&thresholdValue200, nil, &thresholdValue0}), // combination 20: redundant due to combination 19
	...
	// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue0, &thresholdValue0}, valueSequenceErrorSubstring), // combination 24: redundant due to combination 23
	...
	// createInvalidValueTestComponent([]*float64{nil, &thresholdValue200, &thresholdValue0}, missingValueErrorSubstring1), // combination 29: redundant due to combination 25
	// createInvalidValueTestComponent([]*float64{&thresholdValue0, &thresholdValue200, &thresholdValue0}, valueSequenceErrorSubstring),  // combination 30: redundant due to combination 26
	...
	// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue200, &thresholdValue0}, valueSequenceErrorSubstring), // combination 32: redundant due to combination 27

	//---

	// createInvalidValueTestComponent([]*float64{nil, nil, &thresholdValue100}, missingValueErrorSubstring1), // combination 33: redundant due to combination 17
	createValidValueTestComponent([]*float64{&thresholdValue0, nil, &thresholdValue100}), // combination 34
	// createInvalidValueTestComponent([]*float64{&thresholdValue100, nil, &thresholdValue100}, valueSequenceErrorSubstring), // combination 35: redundant due to combination 18
	// createValidValueTestComponent([]*float64{&thresholdValue200, nil, &thresholdValue100}), // combination 36: redundant due to combination 19
	...
	// createInvalidValueTestComponent([]*float64{nil, &thresholdValue100, &thresholdValue100}, missingValueErrorSubstring1, valueSequenceErrorSubstring), // combination 41: redundant due to combination 21
	...
	// createInvalidValueTestComponent([]*float64{&thresholdValue100, &thresholdValue100, &thresholdValue100}, valueSequenceErrorSubstring), // combination 43: redundant due to combination 22
	// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue100, &thresholdValue100}, valueSequenceErrorSubstring), // combination 44: redundant due to combination 23

	// createInvalidValueTestComponent([]*float64{nil, &thresholdValue200, &thresholdValue100}, missingValueErrorSubstring1), // combination 45: redundant due to combination 25
	...
	// createInvalidValueTestComponent([]*float64{&thresholdValue100, &thresholdValue200, &thresholdValue100}, valueSequenceErrorSubstring), // combination 47: redundant due to combination 26
	// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue200, &thresholdValue100}, valueSequenceErrorSubstring), // combination 48: redundant due to combination 27

	//---

	// createInvalidValueTestComponent([]*float64{nil, nil, &thresholdValue200}, missingValueErrorSubstring1), // combination 49: redundant due to combination 17
	// createValidValueTestComponent([]*float64{&thresholdValue0, nil, &thresholdValue200}), // combination 50: redundant due to combination  34
	// createValidValueTestComponent([]*float64{&thresholdValue100, nil, &thresholdValue200}), // combination 51: redundant due to combination 34
	// createInvalidValueTestComponent([]*float64{&thresholdValue200, nil, &thresholdValue200}, valueSequenceErrorSubstring), // combination 52: redundant due to combination 18

	// createInvalidValueTestComponent([]*float64{nil, &thresholdValue0, &thresholdValue200}, missingValueErrorSubstring1), // combination 53: redundant due to combination 37
	// createInvalidValueTestComponent([]*float64{&thresholdValue0, &thresholdValue0, &thresholdValue200}, missingValueErrorSubstring3, valueSequenceErrorSubstring), // combination 54: redundant due to combination 38
	...
	// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue0, &thresholdValue200}, valueSequenceErrorSubstring), // combination 56: redundant due to combination 39

	// createInvalidValueTestComponent([]*float64{nil, &thresholdValue100, &thresholdValue200}, missingValueErrorSubstring1), // combination 57: redundant due to combination 37
	createValidValueTestComponent([]*float64{&thresholdValue0, &thresholdValue100, &thresholdValue200}), // combination 58
	// createInvalidValueTestComponent([]*float64{&thresholdValue100, &thresholdValue100, &thresholdValue200}, valueSequenceErrorSubstring), // combination 59: redundant due to combination 38
	// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue100, &thresholdValue200}, valueSequenceErrorSubstring), // combination 60: redundant due to combination 39

	// createInvalidValueTestComponent([]*float64{nil, &thresholdValue200, &thresholdValue200}, missingValueErrorSubstring1, valueSequenceErrorSubstring), // combination 61: redundant due to combination 21
	// createInvalidValueTestComponent([]*float64{&thresholdValue0, &thresholdValue200, &thresholdValue200}, missingValueErrorSubstring3, valueSequenceErrorSubstring), // combination 62: redundant due to combination 42
	// createInvalidValueTestComponent([]*float64{&thresholdValue100, &thresholdValue200, &thresholdValue200}, valueSequenceErrorSubstring), // combination 63: redundant due to combination 42
	// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue200, &thresholdValue200}, valueSequenceErrorSubstring), // combination 64: redundant due to combination 22
}
...
func TestRetrieveMetricsFromDashboardDataExplorerTile_TileThresholdRuleParsingWithTwoRules(t *testing.T) {
	...
	// List all possible combinations of two threshold colors, where each one may be one of three valid colors (for pass, warn or fail) or an invalid color.
	...
	var twoValueTestComponentVariants = []valueTestComponent{
		...
		// createInvalidValueTestComponent([]*float64{&thresholdValue100, nil}, missingValueErrorSubstring3, incorrectThresholdRuleCountErrorSubstring), // combination 3: redundant due to combination 2
		// createInvalidValueTestComponent([]*float64{&thresholdValue200, nil}, missingValueErrorSubstring3, incorrectThresholdRuleCountErrorSubstring), // combination 4: redundant due to combination 2
		...
		// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue0}, missingValueErrorSubstring3, incorrectThresholdRuleCountErrorSubstring), // combination 8: redundant due to combination 7

		// createInvalidValueTestComponent([]*float64{nil, &thresholdValue100}, missingValueErrorSubstring1, missingValueErrorSubstring3, incorrectThresholdRuleCountErrorSubstring), // combination 9: redundant due to combination 5
		...
		// createInvalidValueTestComponent([]*float64{&thresholdValue100, &thresholdValue100}, missingValueErrorSubstring3, valueSequenceErrorSubstring, incorrectThresholdRuleCountErrorSubstring), // combination 11: redundant due to combination 6
		// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue100}, missingValueErrorSubstring3, incorrectThresholdRuleCountErrorSubstring), // combination 12: redundant due to combination 7

		// createInvalidValueTestComponent([]*float64{nil, &thresholdValue200}, missingValueErrorSubstring1, missingValueErrorSubstring3, incorrectThresholdRuleCountErrorSubstring), // combination 13: redundant due to combination 5
		// createInvalidValueTestComponent([]*float64{&thresholdValue0, &thresholdValue200}, missingValueErrorSubstring3, incorrectThresholdRuleCountErrorSubstring), // combination 14: redundant due to combination 10
		// createInvalidValueTestComponent([]*float64{&thresholdValue100, &thresholdValue200}, missingValueErrorSubstring3, incorrectThresholdRuleCountErrorSubstring), // combination 15: redundant due to combination 10
		// createInvalidValueTestComponent([]*float64{&thresholdValue200, &thresholdValue200}, missingValueErrorSubstring3, valueSequenceErrorSubstring, incorrectThresholdRuleCountErrorSubstring), // combination 16: redundant due to combination 6
	}
