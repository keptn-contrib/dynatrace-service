...
func Test_serviceSynchronizer_fetchKeptnManagedServicesFromDynatrace(t *testing.T) {
	...
	var returnedEntitiesResponse dynatrace.EntitiesResponse
	...
	tests := []struct {
		...
		fields                       fields
		args                         args
		want                         []dynatrace.Entity
		returnedEntitiesListResponse dynatrace.EntitiesResponse
		wantErr                      bool
	}{
		{
			name: "",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := s.EntitiesClient.GetKeptnManagedServices()
