...
func NewActionTriggeredEventHandler(event ActionTriggeredAdapterInterface, client dynatrace.ClientInterface, attachRules *dynatrace.AttachRules) *ActionTriggeredEventHandler {
