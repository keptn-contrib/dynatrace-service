...
func TestProblemsV2Client_GetTotalCountByQuery(t *testing.T) {
	...
	handler.AddExact("/api/v2/problems?from=1571649084000&problemSelector=status%28open%29&to=1571649085000", "./testdata/test_problemsv2client_gettotalcountbyquery.json")
